...
private:
    ...
    void drawFullArc(QPainter *painter, const QRectF &rect);
    void drawInnerPie(QPainter *painter, const QRectF &rect);
    void drawMajorTicks(QPainter *painter, const QRectF &rect);
    void drawMinorTicks(QPainter *painter, const QRectF &rect);
    void drawNumbers(QPainter *painter, const QRectF &rect);
    void drawSpeedText(QPainter *painter, const QRectF &rect);
    void drawCurrentSpeedArc(QPainter *painter, const QRectF &rect);
